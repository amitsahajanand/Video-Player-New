...
public class JzvdStd extends Jzvd {
  ...
  //  RelativeLayout loadingView_editor;
   ...
   // public TextView mRetryBtn;
    ...
    public void init(Context context) {
     ...
     //   loadingProgressBar = findViewById(R.id.loading);
      //  loadingView_editor = findViewById(R.id.loadingView_editor);
...
*/
    ...
    public void showWifiDialog() {
       ...
       /* AlertDialog.Builder builder = new_icon AlertDialog.Builder(getContext());
        builder.setMessage(getResources().getString(R.string.tips_not_wifi));
        builder.setPositiveButton(getResources().getString(R.string.tips_not_wifi_confirm), new_icon DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(getResources().getString(R.string.tips_not_wifi_cancel), new_icon DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
   ...
   /* public void setBatteryLevel() {
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
      ...
      //  loadingView_editor.setVisibility(loadingPro);
