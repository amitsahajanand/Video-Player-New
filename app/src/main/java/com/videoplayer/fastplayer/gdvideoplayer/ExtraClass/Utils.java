...
public class Utils {
    ...
    public static ArrayList<pictureFacer> pictureFacerlist;
...
//
//        makeMeBlink(ad_call_to_action);
//        Ads.Native_exit(activity, llnative, llline, ad_call_to_action);
//
...
//    }
    ...
    public static void isDebuggingCheck(Context context, OnCheckDebug onCheckDebug, boolean... booleans) {
        onCheckDebug1 = onCheckDebug;
