package com.videoplayer.fastplayer.gdvideoplayer.Activity.Whatsapp.Fragment;
...
import com.videoplayer.fastplayer.gdvideoplayer.Activity.Whatsapp.Adapter.WhatsappStatusAdapter;
...
public class WhatsappImgFragment extends Fragment {
    ...
    public ArrayList<WhatsappStatusModel> statusModelArrayList = new ArrayList<>();
    public ArrayList<WhatsappStatusModel> statusModelArrayList_withoutads = new ArrayList<>();
    ...
    private void Declaration(View view) {
        ...
        rv_fileList.addItemDecoration(new ItemOffsetDecoration(10));
    ...
    private void getData() {
        ...
        statusModelArrayList_withoutads = new ArrayList<>();
        statusModelArrayList_withoutads.addAll(statusModelArrayList);
        if (statusModelArrayList.size() > 0) {
            statusModelArrayList = getVideoListForAds(statusModelArrayList);
        }


        whatsappStatusAdapter = new WhatsappStatusAdapter(getActivity(), statusModelArrayList, statusModelArrayList_withoutads);
...
//   intent.putExtra("android.content.extra.SHOW_ADVANCED", true);
  ...
  /*  public void openDirectory(Uri uriToLoad) {
    ...
    public static String getPath(Context context, Uri uri) throws URISyntaxException {
        ...
        if (needToCheckUri && DocumentsContract.isDocumentUri(context.getApplicationContext(), uri)) {
            if (isExternalStorageDocument(uri)) {
                ...
                } else if ("simplevideoshow".equals(type)) {
    ...
    private ArrayList<WhatsappStatusModel> getVideoListForAds(ArrayList<WhatsappStatusModel> videoList) {

        ArrayList<WhatsappStatusModel> finalvideolist = new ArrayList<>();
        int itemcount = 0;
