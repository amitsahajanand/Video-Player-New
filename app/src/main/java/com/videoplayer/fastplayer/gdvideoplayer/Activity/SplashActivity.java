...
import com.videoplayer.fastplayer.gdvideoplayer.Retrofit.APIClient;
...
import static com.videoplayer.fastplayer.gdvideoplayer.ExtraClass.Utils.isdebuggle;
import static com.videoplayer.fastplayer.gdvideoplayer.ExtraClass.Utils.warningdialog;
...
public class SplashActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isdebuggle( SplashActivity.this )) {
            Utils.Get_Developer_Dialog( SplashActivity.this );
    ...
    private void subScribePushChannel() {
        ...
        try {
            FirebaseMessaging.getInstance().subscribeToTopic( "Video_player_av" )
...
//                        Log.d( "sanpdata", "DEBUG" + response.body().vn_show );
...
//
////                        Preference.setFb_interstitial_id("YOUR_PLACEMENT_ID");
////                        Preference.setFb_native_banner_id("YOUR_PLACEMENT_ID");
////                        Preference.setFb_native_id("YOUR_PLACEMENT_ID");
...
//
//                        Preference.setIs_quiz( true );
//                        Preference.setQuiz_header_show( true );
//                        Preference.setIs_small_native_qureka( true );
//                        Preference.setIs_big_native_qureka( true );
//                        Preference.setAd_one_by_one_ids( true );
//
//                    } else {
...
//                    if (BuildConfig.DEBUG) {
//                        Preference.setSocial_downloader(true);
//                        Preference.setVideo_player(true);
//                        Preference.setvideocall_show(true);
//                    } else {
                    Preference.setSocial_downloader( response.body().getPackage().social_downloader );
                    Preference.setImg_gallery( response.body().getPackage().img_gallery );
                    Preference.setvideocall_show( aPackage.videocall_show );
//                    }

                    Preference.setPrivacy_policy_html( response.body().privacypolicy );

                    FirebaseAnalytics.getInstance( SplashActivity.this ).setAnalyticsCollectionEnabled( aPackage.firebase_analytics );

                    Preference.setisLive( aPackage.is_live );
                    ...
                    if (response.body().getPackage().getMaintenance()) {
                        ...
                        if (version1 == real_version1) {
                            ...
                            if (response.body().getPackage().update_coming_soon) {
                                ...
                                startActivity( new Intent( SplashActivity.this, ComingsoonActivity.class ) );
                                finish();
                                return;
                            }
                        }
    ...
    private void LoadNativeAds() {
        Ids_Class.Laod_NativeAds( SplashActivity.this );
    }
...
//            startUIUpdateTask();
    ...
    private void prepareVpn() {
        if (!Utils.vpnStart) {
            Utils.isConnectingToInternet( SplashActivity.this, new Utils.OnCheckNet() {
                @Override
...
//            Toast.makeText(Splash_Screen.this, "Permission Deny !! ", Toast.LENGTH_SHORT).show();
    ...
    private void IntentActivy() {
        ...
        if (Preference.getComing_soon()) {
            ...
            if (Preference.getisVpnConnect()) {
                ...
                if (Preference.getVPN_Show()) {
                    Intent intent = new Intent( SplashActivity.this, N_Screen.class );
    ...
    private void Main_Intent_Pass() {
        if (Preference.getScreen_show() > 3) {
            fromstart = 3;
            startActivity( new Intent( SplashActivity.this, LetsgoActivity.class ) );
            finish();
    ...
    private void GetWaringDialog() {
        ...
        Waringdialog = new Dialog( SplashActivity.this );
