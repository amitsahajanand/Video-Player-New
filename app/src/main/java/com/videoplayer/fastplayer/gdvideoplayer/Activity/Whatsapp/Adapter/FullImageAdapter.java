...
public class FullImageAdapter extends PagerAdapter {
    ...
    public FullImageAdapter(Activity context, ArrayList<WhatsappStatusModel> imageList) {
...
//        final ImageView im_delete = imageLayout.findViewById(R.id.im_delete);
        ...
        if (imageList.get(position).getUri().toString().endsWith(".mp4")) {
            im_vpPlay.setVisibility(View.VISIBLE);
        } else {
            im_vpPlay.setVisibility(GONE);
        }
