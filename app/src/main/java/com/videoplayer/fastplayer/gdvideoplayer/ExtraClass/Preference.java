...
public class Preference {
    ...
    private static final String img_gallery = "img_gallery";
    ...
    public static String getselectedImageUri() {
        return get().getString(selectedimageUri, "");
    }

    public static void setselectedImageUri(String value) {
        get().edit().putString(selectedimageUri, value).apply();
    }
    ...
    public static void setImg_gallery(boolean value) {
        get().edit().putBoolean(img_gallery, value).apply();
    }

    public static boolean getImg_gallery() {
        return get().getBoolean(img_gallery, false);
    }
