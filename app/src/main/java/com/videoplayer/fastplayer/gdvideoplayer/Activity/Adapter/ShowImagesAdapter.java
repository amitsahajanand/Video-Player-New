...
import com.videoplayer.fastplayer.gdvideoplayer.Activity.FullView.vplayer.jzvd.VideoPlayerActivity;
...
public class ShowImagesAdapter extends PagerAdapter {
    ...
    public ShowImagesAdapter(Activity context, ArrayList<File> imageList, FullViewActivity fullViewActivity) {
    ...
    public ShowImagesAdapter(Activity context, ArrayList<File> imageList, FulllWhatsappScreen fulllWhatsappScreen) {
        this.context = context;
        this.imageList = imageList;
        this.fulllWhatsappScreen = fulllWhatsappScreen;
        inflater = LayoutInflater.from(context);
    }

    public void Update(ArrayList<File> imageList){
        this.imageList = imageList;
    ...
    public Object instantiateItem(@NotNull ViewGroup view, int position) {
        ...
        final RoundedImageView imageView = imageLayout.findViewById(R.id.im_fullViewImage);

        final ImageView im_vpPlay = imageLayout.findViewById(R.id.iv_play);
...
//            intent.setDataAndType(Uri.parse(imageList.get(position).getPath()), "simplevideoshow/*");
//            context.startActivity(intent);
            ...
            Ads_Interstitial.showAds_full(context, new Ads_Interstitial.OnFinishAds() {
                ...
                public void onFinishAds(boolean b) {
                    ...
                    context.startActivity(new Intent(context, VideoPlayerActivity.class).putExtra("share", imageList.get(position).getPath()));
                }
            });
