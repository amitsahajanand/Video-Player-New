...
public class ImageFolderAdapter extends RecyclerView.Adapter<ImageFolderAdapter.FolderHolder> implements Filterable {
    ...
    public ImageFolderAdapter(ArrayList<imageFolder> folders, Context folderContx, itemClickListener listen, boolean isshow) {
    ...
    public FolderHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View cell;
        if (isshow) {
            cell = inflater.inflate( R.layout.picture_folder_item, parent, false );
        } else {
