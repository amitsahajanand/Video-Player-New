package com.videoplayer.fastplayer.gdvideoplayer.Player.videoService;
...
import com.videoplayer.fastplayer.gdvideoplayer.Activity.Video.VideoListActivity;
import com.videoplayer.fastplayer.gdvideoplayer.Model.VideoModel;
import com.videoplayer.fastplayer.gdvideoplayer.Player.CustomUi.PlayPauseDrawable;
import com.videoplayer.fastplayer.gdvideoplayer.Player.GlobalVar;
import com.videoplayer.fastplayer.gdvideoplayer.Player.PlayerManager;
...
//        PendingIntent clickIntent = PendingIntent.getActivity(this, 0, nowPlayingIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            clickIntent = PendingIntent.getActivity
                    ( this, 0, nowPlayingIntent, PendingIntent.FLAG_MUTABLE );
        } else {
            clickIntent = PendingIntent.getActivity
