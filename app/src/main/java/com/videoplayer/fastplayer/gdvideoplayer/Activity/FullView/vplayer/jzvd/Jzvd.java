...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public static JZMediaInterface mediaInterface;
    ...
    public TextView tv_count_progress;
    ...
    public void init(Context context) {
        ...
        tv_count_progress = findViewById(R.id.tv_count_progress);
    ...
    public void tv_visibility(Boolean check) {
        if (check) {
            tv_count_progress.setVisibility(VISIBLE);
        } else {
            tv_count_progress.setVisibility(GONE);
        }
    }
