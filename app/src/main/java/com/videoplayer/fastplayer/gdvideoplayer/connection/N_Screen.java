...
import com.videoplayer.fastplayer.gdvideoplayer.ExtraClass.Appcontroller;
...
public class N_Screen extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with( N_Screen.this ).load( APIClient.img_url + Preference.getServer_image() ).error( R.drawable.n_place ).placeholder( R.drawable.n_place ).into( iv_flag );
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            Utils.isConnectingToInternet( N_Screen.this, new Utils.OnCheckNet() {
                @Override
            ...
            Toast.makeText( N_Screen.this, "Permission Deny !! ", Toast.LENGTH_SHORT ).show();
        }
    }
    ...
    private boolean isConnecting() {
        ...
        if (txt_status.getText().toString().equals( N_Screen.this.getResources().getString( R.string.switch_off ) ) || txt_status.getText().toString().equals( N_Screen.this.getResources().getString( R.string.switch_on ) )) {
            isConnecting = false;
        } else {
            isConnecting = true;
            ...
            Utils.isConnectingToInternet( N_Screen.this, new Utils.OnCheckNet() {
                ...
                public void OnCheckNet(boolean b) {
                    if (b) {
                        ...
                        Intent intent = VpnService.prepare( N_Screen.this );
    ...
    public void status(String status) {
        ...
        if (status.equals( "connect" )) {
            ...
            img_off_on.setImageResource( R.drawable.ic_disonnect );
            ...
            Ads_VN_Screen.VN_showAds( N_Screen.this, new Ads_Interstitial.OnFinishAds() {
                @Override
                public void onFinishAds(boolean b) {
                    startActivity( new Intent( N_Screen.this, Privacy_Policy_Screen.class ) );
                }
            } );
                    ...
                    UnifiedSdk.getInstance().getVpn().start( new SessionConfig.Builder()
                        ...
                        public void error(@NonNull VpnException e) {
                            ...
                            if (e.getMessage().contains( "TRAFFIC_EXCEED" )) {
                                ...
                                Toast.makeText( N_Screen.this, "try again!", Toast.LENGTH_SHORT ).show();
...
//                Utils.isVpnConnect = false;
        ...
        call.enqueue( new retrofit2.Callback<TraficLimitResponse>() {
            ...
            public void onResponse(Call<TraficLimitResponse> call, Response<TraficLimitResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText( N_Screen.this, "Something went wrong!", Toast.LENGTH_SHORT ).show();
                }
        ...
        call.enqueue( new retrofit2.Callback<TraficLimitResponse>() {
            ...
            public void onResponse(Call<TraficLimitResponse> call, Response<TraficLimitResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText( N_Screen.this, "Please connect again vpn!", Toast.LENGTH_SHORT ).show();
                } else {
    ...
    public void onResume() {
        ...
        Resources resources = N_Screen.this.getResources();
